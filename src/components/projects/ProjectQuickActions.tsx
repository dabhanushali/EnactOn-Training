...
export const ProjectQuickActions = ({ 
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
      {/* Total Projects */}
      {!canManage && <Card className="border-0 shadow-md bg-gradient-to-br from-indigo-50 to-white hover:shadow-lg transition-all">
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 rounded-xl bg-indigo-500/10">
              <FolderOpen className="w-6 h-6 text-indigo-600" />
      ...
      {/* Active Projects */}
      {!canManage && <Card className="border-0 shadow-md bg-gradient-to-br from-amber-50 to-white hover:shadow-lg transition-all cursor-pointer"
            onClick={() => navigate('/projects')}>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 rounded-xl bg-warning/10">
      ...
      {/* Completed Projects */}
      {!canManage && <Card className="border-0 shadow-md bg-gradient-to-br from-emerald-50 to-white hover:shadow-lg transition-all">
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="p-3 rounded-xl bg-success/10">
              <CheckCircle className="w-6 h-6 text-success" />
      ...
      {/* Pending Evaluations or Quick Action */}
      {!canManage && (<Card className="border-0 shadow-md bg-gradient-to-br from-cyan-50 to-white hover:shadow-lg transition-all">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 rounded-xl bg-primary/10">
                <TrendingUp className="w-6 h-6 text-primary" />
