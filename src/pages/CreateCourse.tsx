...
export default function CreateCourse() {
  ...
  const [extractedData, setExtractedData] =
    useState<ExtractedCourseData | null>(null);

  // Sheet import states
  const [sheetParsedData, setSheetParsedData] =
    useState<ParsedCourseData | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description:
          "Course created successfully. Now you can add modules and assessments.",
      });
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Import course structure from Google Sheets with modules and
                    content items automatically extracted.
                  </p>
                </CardContent>
              </Card>
              ...
              >
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Extract course content from URLs, ClickUp, Notion, CSV
                    files, or let AI generate modules for you.
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              >
                <TabsList className="grid w-full grid-cols-3">
                  ...
                  <TabsTrigger value="modules" disabled={!courseId}>
                    Modules {courseId ? "" : "(Save first)"}
                  </TabsTrigger>
                  <TabsTrigger value="assessments" disabled={!courseId}>
                    Assessments {courseId ? "" : "(Save first)"}
                  </TabsTrigger>
                </TabsList>
                <TabsContent value="details" className="mt-4">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <RequiredLabel htmlFor="course_name">
                          Course Name
                        </RequiredLabel>
                        <Input
                          id="course_name"
                      ...
                      <div>
                        <RequiredLabel htmlFor="course_description">
                          Course Description
                        </RequiredLabel>
                        <Textarea
                      ...
                      <div>
                        <RequiredLabel htmlFor="course_type">
                          Course Type
                        </RequiredLabel>
                        <Select
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            handleInputChange("target_role", value)
                          }
                        >
                          <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange("completion_rule", value)
                        }
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          <SelectItem value="pass_all_assessments">
                            Pass All Assessments
                          </SelectItem>
                          <SelectItem value="pass_minimum_percentage">
                            Pass Minimum Percentage
                          </SelectItem>
                          <SelectItem value="pass_mandatory_only">
                            Pass Mandatory Only
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    ...
                    {formData.completion_rule === "pass_minimum_percentage" && (
                      <div>
                        <Label htmlFor="minimum_passing_percentage">
                ...
                <TabsContent value="assessments" className="mt-4">
                  ...
                  {assessments.length === 0 ? (
                    <p className="text-center text-muted-foreground">
                      No assessments added yet. Click "Add Assessment" to get
                      started.
                    </p>
                  ) : (
                    <div className="space-y-4">
                          ...
                          <CardContent className="p-4 flex justify-between items-center">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground mt-1">
                                Type: {assessment.assessment_type} Passing:{" "}
                                {assessment.passing_score}% Time:{" "}
          ...
          {creationMode === "auto" && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold">
                  Auto-Generate Course from Link
                </h3>
                <Button
                  variant="outline"
                  onClick={() => {
              ...
              {!extractedData ? (
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Paste a URL from ClickUp, Notion, documentation sites, or
                    any web content to automatically extract course details and
                    modules.
                  </p>
                  ...
                  <Button
                    onClick={async () => {
                      ...
                      try {
                        ...
                        if (!data.success) {
                          throw new Error(
                            data.error || "Failed to generate course data"
                          );
                        }
                        ...
                        toast({
                          title: "Success",
                          description: `Generated course with ${
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <Select
                            value={
                              extractedData.course?.difficulty_level ||
                              "Intermediate"
                            }
                            onValueChange={(value) =>
                              setExtractedData((prev) => ({
                        ...
                        <div className="md:col-span-2">
                          ...
                          <Textarea
                            value={
                              extractedData.course?.course_description || ""
                            }
                            onChange={(e) =>
                              setExtractedData((prev) => ({
                                ...prev,
                        ...
                        <div className="md:col-span-2">
                          ...
                          <Textarea
                            value={
                              extractedData.course?.learning_objectives || ""
                            }
                            onChange={(e) =>
                              setExtractedData((prev) => ({
                                ...prev,
                          ...
                          <Card key={idx}>
                            <CardContent className="p-4">
                              ...
                              <div className="flex gap-4 mt-2 text-xs text-muted-foreground">
                                ...
                                <span>
                                  Duration: {module.estimated_duration_minutes}
                                  min
                                </span>
                                {module.content_url && (
                                  <span className="truncate">
                                    URL: {module.content_url}
                                  </span>
                                )}
                              </div>
                            </CardContent>
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button
                      onClick={async () => {
                        setLoading(true);
                        try {
                          // Step 1: Create the course (this part is correct)
                            ...
                            await supabase
                              ...
                              .insert({
                                ...
                                difficulty_level:
                                  ...
                                  "Intermediate",
                                target_role:
                                  extractedData.course.target_role || "",
                                learning_objectives:
                                  extractedData.course.learning_objectives ||
                                  "",
                                created_by: profile?.id,
                          ...
                          // Step 2: Insert the PARENT modules
                          const modulesToInsert = extractedData.modules.map(
                            (mod, idx) => ({
                              course_id: course.id,
                              module_name: mod.module_name,
                              module_description: mod.module_description,
                          ...
                          const { data: insertedModules, error: modulesError } =
                            await supabase
                              .from("course_modules")
                              .insert(modulesToInsert)
                              .select();
                          ...
                          // Step 3: Insert the CHILD content items
                          const contentsToInsert: any[] = [];
                          extractedData.modules.forEach((mod, modIdx) => {
                            // Use the ID from the module we just inserted
                            const moduleId = insertedModules[modIdx].id;
                          ...
                          toast({
                            title: "Success!",
                            description: `Course created with ${insertedModules.length} modules and ${contentsToInsert.length} content items`,
                          });
            ...
            <AssessmentDialog
              ...
              onAssessmentSave={(newAssessment) => {
                if (editingAssessment) {
                  setAssessments((prev) =>
                    prev.map((a) =>
                      a.id === newAssessment.id ? newAssessment : a
                    )
                  );
                } else {
